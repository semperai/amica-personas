  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-xl max-h-[80vh] bg-white/95 backdrop-blur-xl shadow-2xl rounded-lg overflow-hidden flex flex-col z-50">
        ...
        <div
          className="flex-shrink-0 bg-white/95 backdrop-blur-xl px-3 py-2 border-b border-slate-200/50"
          ref={topMenuRef}
        >
          <div className="flex items-center justify-between">
                ...
                {breadcrumbs.map((breadcrumb) => (
                  <li key={breadcrumb.key} className="flex">
                    <div className="flex items-center">
                      <ChevronRightIcon className="h-3.5 w-3.5 flex-shrink-0 text-slate-400" aria-hidden="true" />
                      <span
                        onClick={() => {
                        ...
                        className="ml-1.5 text-xs font-medium text-slate-700 hover:text-slate-900 cursor-pointer transition-colors"
                      >
                        {breadcrumb.label}
                      </span>
                    </div>
            ...
            <button
              onClick={onClickClose}
              className="bg-slate-100 hover:bg-slate-200 text-slate-900 rounded p-1 transition-colors cursor-pointer ml-2 flex-shrink-0"
            >
