...
import {AmicaTokenMainnet} from "./AmicaTokenMainnet.sol";

/**
 * @title AmicaTokenMainnetV2
 * @author Kasumi
 * @notice V2 upgrade of AmicaTokenMainnet for testing upgrade mechanism
 * @dev Inherits all V1 functionality and adds upgradeTest() for verification
 */
contract AmicaTokenMainnetV2 is AmicaTokenMainnet {
    /**
