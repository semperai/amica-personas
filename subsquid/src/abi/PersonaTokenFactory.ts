...
export const functions = {
    ...
    getMetadataValue: viewFun("0x51c0dfbd", "getMetadataValue(uint256,string)", {"tokenId": p.uint256, "key": p.string}, p.string),
...
export class Contract extends ContractBase {
    ...
    getMetadataValue(tokenId: GetMetadataValueParams["tokenId"], key: GetMetadataValueParams["key"]) {
        return this.eth_call(functions.getMetadataValue, {tokenId, key})
    }
...
export type GetMetadataValueParams = FunctionArguments<typeof functions.getMetadataValue>
export type GetMetadataValueReturn = FunctionReturn<typeof functions.getMetadataValue>
