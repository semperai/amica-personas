...
export const functions = {
    AMICA_DEPOSIT_AMOUNT: viewFun("0x43486bd2", "AMICA_DEPOSIT_AMOUNT()", {}, p.uint256),
    BONDING_CURVE_AMOUNT: viewFun("0x9ca1941a", "BONDING_CURVE_AMOUNT()", {}, p.uint256),
    LIQUIDITY_TOKEN_AMOUNT: viewFun("0xfe6f7694", "LIQUIDITY_TOKEN_AMOUNT()", {}, p.uint256),
    ...
    createPersona: fun("0x1a408796", "createPersona(address,string,string,string[],string[],uint256)", {"pairingToken": p.address, "name": p.string, "symbol": p.string, "metadataKeys": p.array(p.string), "metadataValues": p.array(p.string), "initialBuyAmount": p.uint256}, p.uint256),
    ...
    getPersona: viewFun("0x14f9dc8b", "getPersona(uint256)", {"tokenId": p.uint256}, {"name": p.string, "symbol": p.string, "erc20Token": p.address, "pairToken": p.address, "pairCreated": p.bool, "createdAt": p.uint256}),
    ...
    personas: viewFun("0x40291e6a", "personas(uint256)", {"_0": p.uint256}, {"name": p.string, "symbol": p.string, "erc20Token": p.address, "pairToken": p.address, "pairCreated": p.bool, "createdAt": p.uint256}),
...
export class Contract extends ContractBase {
    ...
    AMICA_DEPOSIT_AMOUNT() {
        return this.eth_call(functions.AMICA_DEPOSIT_AMOUNT, {})
    }

    BONDING_CURVE_AMOUNT() {
        return this.eth_call(functions.BONDING_CURVE_AMOUNT, {})
    }

    LIQUIDITY_TOKEN_AMOUNT() {
        return this.eth_call(functions.LIQUIDITY_TOKEN_AMOUNT, {})
    }
...
/// Function types
export type AMICA_DEPOSIT_AMOUNTParams = FunctionArguments<typeof functions.AMICA_DEPOSIT_AMOUNT>
export type AMICA_DEPOSIT_AMOUNTReturn = FunctionReturn<typeof functions.AMICA_DEPOSIT_AMOUNT>

export type BONDING_CURVE_AMOUNTParams = FunctionArguments<typeof functions.BONDING_CURVE_AMOUNT>
export type BONDING_CURVE_AMOUNTReturn = FunctionReturn<typeof functions.BONDING_CURVE_AMOUNT>

export type LIQUIDITY_TOKEN_AMOUNTParams = FunctionArguments<typeof functions.LIQUIDITY_TOKEN_AMOUNT>
export type LIQUIDITY_TOKEN_AMOUNTReturn = FunctionReturn<typeof functions.LIQUIDITY_TOKEN_AMOUNT>
